const menu = [
...

    {
        ...
        items: [
            ...
            {name:"شیک کوکی گردو", price:"270"},
            {name:"شیک بنانا نات", price:"280"},
            {name:"شیک اسنیکرز", price:"285"},
            {name:"شیک چاکلت مینت", price:"280"},
            {name:"شیک بادام زمینی موز", price:"278"},
            {name:"شیک نسکافه بیسکوییت", price:"280"},
            {name:"شیک لوتوس", price:"280"},
            {name:"شیک میکس بری", price:"250"},
            {name:"شیک کارامل کیک", price:"290"},
            {name:"شیک دارک", price:"344"},
            {name:"شیک زرشک", price:"259"},
            {name:"شیک قهوه", price:"260"},
            {name:"شیک توت فرنگی", price:"280"},
            {name:"شیک سیگنیچر", price:"276"}
        ]
    },
...

    {
        category: "اسموتی",
        items: [
            {name:"اسموتی منگو پیچ", price:"210"},
            {name:"اسموتی بری", price:"210"},
            {
            ...
            {name:"اسموتی گرین", price:"200"},
            {name:"اسموتی هندوانه", price:"210"},
            {name:"اسموتی اورنج بری", price:"215"},
        ]
    },
    
    {
        category: "فراپه",
        items: [
            {name:"فراپه کلاسیک", price:"210"},
            {name:"فراپه کوکو", price:"230"},
            {name:"فراپه تیرامیسو نعنا", price:"230"},
            {name:"فراپه کوکی نات", price:"210"},
            {name:"چاکلت بری فراپه", price:"240"}
        ]
    },
