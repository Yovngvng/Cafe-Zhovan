const menu = [
...

    {
        category: "کیک و دسر",
        items: [
            {name:"کیک نوتلا", price:"270"},
            {name:"کیک سه شیر", price:"260"},
            {name:"کیک تیرامیسو", price:"260"},
            {name:"چیز کیک شاتوت", price:"250"},
            {name:"کیک آناناس", price:"260"},
            {name:"کیک شکلات خامه", price:"274"},
            {name:"وافل", price:"400"},
            {name:"چیز کیک دبل چاکلت", price:"260"},
            {name:"چیز کیک اسنیکرز", price:"260"},
            {name:"کیک موز شکلات", price:"260"},
            {name:"گاتا", price:"250"},
            {name:"چیز کیک نوتلا", price:"250"},
            {name:"کیک تاکسیدو", price:"270"},
            {name:"باکس کیک توت فرنگی", price:"290"},
            {name:"کیک موکا بیسکوییتی", price:"270"},
            {name:"کیک دوبوس", price:"270"},
            {name:"کیک شکلات خیس", price:"260"},
            {name:"کیک موس شکلات", price:"270"}
        ]
    },
...

    {
        ...
        items: [
            ...
            {name:"سیب زمینی ساده تک نفره", price:"310"},
            {name:"سیب زمینی ساده دو نفره", price:"370"},
            {name:"سیب زمینی چدار تک نفره", price:"352"},
            {name:"سیب زمینی چدار دو نفره", price:"405"},
            {name:"سیب زمینی با بیکن تک نفره", price:"378"},
            {name:"سیب زمینی با بیکن دو نفره", price:"418"},
            {name:"سالاد سزار تک نفره", price:"504"},
            {name:"سالاد سزار دو نفره", price:"588"}
        ]
    },
